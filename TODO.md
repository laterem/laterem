...
- [ ] Сделать возможность менять дерево работ без перезапуска сервера `Зарезервировано: Жура`
    ...
    - [x] Хранить личные особенности дерева заданий ученика (выполненные/недоступные задания и т.п.)  `Сделано: Спайд`
=======
...
>>>>>>> fb0333e216f17210e18ae1947b083f935185cff3
...
- [x] Починить левое меню `Свободно`
