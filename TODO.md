...
- [ ] Уникальная индексация задач и обсидианизация поиска имён задач
- [ ] Категории работ: Категория предмета, подкатегория темы, объект работы.
    - [ ] Страницы/__панель__ навигации соответствующие категории. Отдельная страница для работы

***
## Глобальные задания

- [ ] Изучить вопрос абсолютных путей к шаблонам 
- [ ] Покрыть непокрытое за спринт 20.10.2022
...
- [ ] Убедиться, что сессии не хранятся у клиентов и DTCJsonы не находятся в кукизах. 
    - [ ] Если таки храняться, то сделать так, чтобы этого не было

### Движок задач
- [ ] Добавить поддержку двойных кавычек для скобок
