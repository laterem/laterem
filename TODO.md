...
- [ ] Подчистить ненужную отладку 
- [ ] Исправить проблему неотсортированности директории по алфавиту в rdir_to_tree
...
- [ ] Объединить задания в сессии в словарь

### Бренд и косметика
- [ ] Переименовать всё с DEW на Laterem
- [x] Изменить размеры svg `Сделано: Спайд`
- [ ] Перевести фронт в формат table (или как-то по другому расстолбить сайт)
- [x] Настроить фавиконы `Сделано: Жура`
- [x] Вынести основные цвета сайта в отдельный файл 

### Рефакторинг
- [x] Переделать систему наименования метадокументов о проекте. `Зарезервировано: Спайд`
- [ ] Переписать весь используемый в проекте функционал модуля os.path под pathlib `Свободно`
- [ ] Глобальная переименовальня `Зарезервировано: Спайд`
...
- [ ] Сделать нормальную проверку задач с чек боксами (сейчас работает только для задач с одним ответом) `Зарезервировано: Спайд`
