...
- [ ] Сделать форму для баг-репортов
    - [ ] Возможность добавления скриншотов
- [ ] Починить баг с энтером в переименовании
- [ ] Сделать сохранение состояний дерева
- [ ] Кнопка удаления категорий и работ
- [ ] Кнопка закрытия всплывающего окна (который с blackout'ом)
- [ ] Вставить нужные иконки
- [ ] Шаблоны под все возможные типы задач, от которых можно отталкиваться при составлении новых
- [ ] Скачивание шаблона с его страницы

- [ ] Просмотр шаблонов задач на сайте
