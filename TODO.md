...
- [ ] Панель управления учителя:
    - [ ] Окно взаимодействия с базой учеников
        ...
        - [ ] Удаление учеников
    - [ ] (Необязательно на текущий спринт) Окно взаимодействия с группами учеников
        - [ ] Заведение групп
        - [ ] Изменение групп
            - [ ] Добавление и удаление пользователей группы
        - [ ] Назначение работ группам
        - [ ] Удаление групп
- [ ] БД система, поддерживающая сущности данных, описанных выше
...
- [ ] Сделать выбор темы отдельной открывающейся менюшкой (например, список тем, в котором подсвечена выбранная тема)
- [ ] Добавить закладки на задачах - пометка приоритета выполнения
- [ ] Сделать подсказки при наведении на кнопки
- [ ] Сделать базовую страницу (для не зарегистрированного пользователя - реклама сайта; для обычного пользователя- система рекомендаций/календарь работ)


### Движок задач (Основной ответственный - Спайд)
- [ ] Добавить запрещаторы в LTC
...
- [ ] Панель управления
    - [ ] Сделать интерактивный инструмент пакетной авторизации, который работает через БД
