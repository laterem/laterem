...
- [ ] Сделать защиту от дурака
    - [ ] Сделать выпадающие списки в энумо-подобных полях (выбор пользователей, выбор типа задачи и т.д.)
...
## Система данных
- [ ] Отказаться от data/works и data/userdata
    - [ ] Автоматизировать регистрацию админ-пользователя при пустой БД
