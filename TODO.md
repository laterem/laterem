...
- [x] Сделать красивое оформление сайта для демонстрации
    - [x] Лого 
    - [x] Название `Сделано совиестно`
    - [x] Дизайн страниц
        - [x] Нормальное дерево работ `Сделано: Жура`
        - [х] Сделать минимальную высоту меню дерева на всю страницу `Сделано: Жура`
...
- [ ] Переписать _submenu
    - [ ] убрать path
- [ ] Сделать так, чтобы Джанго дополнял view.html общими строками `Зарезервировано: Спайд`
...
- [ ] Кнопка перехода на следующую незелёную задачу в работе `Зарезервировано: Жура`
