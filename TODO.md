...
- [ ] Полировка
  ...
  - [ ] CRUD полнота
    ...
    - [ ] Добавить изменение названий шаблонов задач
      - [ ] ФРОНТ `Зарезервировано: Жура`
      - [ ] БЭК `Зарезервировано: Спайд`
    - [ ] Реализовать удаление работ и категорий `Зарезервировано: Спайд`
    - [ ] Реализовать удаление групп `Зарезервировано: Спайд`
  - [x] Исправление ошибки с .0 `Зарезервировано: Спайд`
  - [ ] Убрать кнопку "импорт" из страницы работ `Зарезервировано: Жура`
